export const en = {
  ...
  footer: {
    ...
    subscribe: {
      title: "Subscribe",
      body: "Sign up with your email address to receive news and updates. We respect your privacy.",
      placeholder: "you@company.com",
      ariaEmail: "Email address",
      ariaSubmit: "Subscribe",
    },
    copyright: "Copyright © {year} sayhii, inc. All rights reserved.",
    trademark:
  ...
  home: {
    ...
    uniquely: {
      ...
      title: "Three reasons it's *not* like the others.",
      pillars: [
        {
    ...
    stories: {
      ...
      title: "In the words of the people *already* in sayhii.",
      quotes: [
        "There are many things unique about sayhii, but most of all, that it touches the whole employee lifecycle.",
        "This is the missing piece for us.",
        "There is nothing out there like this… Nothing!",
        "Sayhii is a hi-tech, easy to use, conduit into existing levels of motivation, commitment, and engagement that otherwise would be a mystery.",
        "I hear this and my initial thought is, 'It's genius!'",
        "Sayhii takes it from being an event to an integrated part of your day that you don't have to think about.",
        "That the program doesn't hinge on the success of any one group's success is critical.",
        "The team view was super interesting and made me want to dig into it more.",
      ],
    },
    cta: {
      eyebrow: "It all starts with sayhii",
      title: "Create a *win-win* workplace.",
      sub: "People are the heart of your business. We help you help them thrive. When you're ready to sayhii, we're ready to answer.",
      primary: "Schedule a 30-min chat",
    },
  },
  notes: {
  ...
  contact: {
    ...
    sidebar: {
      emailEyebrow: "Email us directly",
      visitEyebrow: "Visit",
      readyEyebrow: "When you're ready",
      readyBody: "When you're ready to sayhii, we're ready to answer.",
    },
    form: {
      stepLabel: "Step 1 of 1",
      heading: "Tell us a little about you.",
      sub: "Five fields. We'll send a calendar link within an hour.",
      labels: {
        name: "Your name",
        email: "Work email",
        company: "Company",
        headcount: "Headcount",
        message: "What are you hoping to see?",
      },
      placeholders: {
        name: "Jamie Rivera",
        ...
        headcount: "220",
        message: "We're considering replacing our annual survey...",
      },
      submit: "Request a walkthrough",
      submitting: "Sending…",
      footnote: "We don't do drip sequences. One real human will reply.",
      errors: {
    ...
    success: {
      eyebrowPrefix: "Got it,",
      heading: "We'll be in touch within the hour.",
